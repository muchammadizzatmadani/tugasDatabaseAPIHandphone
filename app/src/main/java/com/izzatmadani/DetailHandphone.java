...
import com.izzatmadani.model.Handphone;
import com.izzatmadani.server.AsyncInvokeURLTask;
...
public class DetailHandphone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.amingnurfalah.R.layout.activity_detail_handphone);
        handphone = new Handphone();
        initView();
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    }
    private void initView(){
        textNama = (EditText) findViewById(com.amingnurfalah.R.id.add_new_nama);
        textHarga = (EditText) findViewById(com.amingnurfalah.R.id.add_new_harga);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.amingnurfalah.R.menu.activity_main_action, menu);
        return true;
    }
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            case android.R.id.home:
                goToMainActivity();
                break;
            case com.amingnurfalah.R.id.action_menu_edit:
                ...
                startActivity(in);
                break;
            case com.amingnurfalah.R.id.action_menu_delete:
                delete();
                break;
        }
